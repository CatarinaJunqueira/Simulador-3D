...
function [mov_total,patio,Navio,lista_descarregamento] = mover_porto(patio,l_navio,vzio,Navio,RegraCarregamento,porto,lista_descarregamento,navio,localiza)
...
u=isempty(l_navio);
     ...
     while u~=1        
        ...
        [l_navio] = feval(localiza,porto2,patio,navio2,1);
        u=isempty(l_navio);
